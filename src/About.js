  ...
  render() {
    return (
      <section className="about">
        ...
        <p className="about__text">Under the <strong>Schedules</strong> tab you can see the upcoming schedule for each of your favourite teams. Click <i class="fas fa-sync-alt"></i> to refresh team schedules.</p>
